...
<section style="position:relative;">
	<div class="rSlider css-transitions">
    	<div class="rSlider--view" style="margin-left: 0px;">
		<!-- slide -->
      		<div class="rSlider--slide" style="width: 966px; height: 500px;">
				...
				<div class="rSlider--image" style="background-image: url(&quot;images/slider-img-001.jpg&quot;);"></div>
        		<div class="rSlider--bg-color"></div>
			</div>
    		<!-- Controls -->
    		<div class="rSlider--dots-controls"><button data-slide-index="0" class="active"></button></div>
   		</div>
	</div>
	...
	<div class="container">
		<div class="latest-prdt-blk ">
        	...
        	<?php foreach($latestProducts as $latestProduct){
        			$bodyStr= $latestProduct["Description"];
	...
	<div class="offer-hding-blk">
     ...
     <div class="row">
     	...
     	foreach($latestCategories as $fetchCat){
     		$i++;
     		$imgSrc="images/bed.svg";
     		if($i==1){
     			$imgSrc="images/bed.svg";
     		}elseif($i==2){
     			$imgSrc="images/kitchen.svg";
     		}elseif($i==3){
     	...
     	<div class="col-sm-4 ">
        	<div class="service-blk">
                ...
                <p><?php $bodyStr= $fetchCat["description"];
                	$firstSPosNum=stripos($bodyStr,"<p>");
					$firstEPosNum=stripos($bodyStr,"</p>");
                ...
                ?></p>
                <?php }	?>
                <a HREF="products.php?category=<?php echo $fetchCat["uuid"];?>">View Products</a>
