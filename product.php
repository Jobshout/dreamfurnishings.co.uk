        	...
        	<?php if(isset($dbProductData['product_images']) && $dbProductData['product_images']>0){  ?>
         		...
         		<div class="col-md-4">
            		...
            		<div CLASS="row">
            			...
            			<?php } ?>
            			<div class="col-sm-4 pading-lft displayCartsClass" style=""><a href="cart.php" class=" btn btn-default" style=" border-radius:1px; line-height:30px; margin-bottom:10px; font-size: 12px; position: relative; width:100%;"><span class="cartItemsClass">0</span> item(s) in cart</a></div>
