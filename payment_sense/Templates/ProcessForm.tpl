<div>
	<div style="font-size: 16pt; color: #000;">
		<p>
		  Transferring to <strong><font color="#F7941D">Payment</font><font color="#1E4783">Sense</font></strong> Secure Payment Form
		</p>
	...
	<input type="hidden" name="EchoCardType" value="<?= $szEchoCardType ?>" />
	...
	<input type="hidden" name="EmailAddress" value="<?= $szEmailAddress ?>" />
	<input type="hidden" name="PhoneNumber" value="<?= $szPhoneNumber ?>" />
	<input type="hidden" name="EmailAddressEditable" value="<?= $szEmailAddressEditable ?>" />
	<input type="hidden" name="PhoneNumberEditable" value="<?= $szPhoneNumberEditable ?>" />
