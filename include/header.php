...
<div STYLE="background-color:#e0e3df;">
	<div CLASS="row" STYLE="padding: 7px 20px; width:100%;">
		<div CLASS="col-md-12 text-right" STYLE="padding-right:0px;">
			...
			<a HREF="cart.htm" CLASS="btn btn-danger btn-sm displayCartsClass" STYLE="margin-left:7px; display:none;"> <i CLASS="fa fa-cart-plus"></i> &nbsp; Cart <span class="cart_items cartItemsClass">0</span></a>
		</div>
	</div>
</div>
<header>
